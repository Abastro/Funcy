...
completed x = \case
  ...
  Bundle maps -> Bundle $ mapOverMap (completed x) maps -- Enough to 'complete' on each part
  ...
  Choose maps -> Uncurried (Choose $ mapOverMap (coerce completedSkewed) maps) . commPair
